...
main() async {
  //in main it will check if the user email is present in the key
  // then go to chatscreen else login screen
  //here in the app when it restart the app it will goto login page
  //for this it  will take email from key the email is remove from key when the user click logOut
  ...
  runApp(MaterialApp(
    ...
    //now if it restart or close our app and again open the app it will  directly go to ChatScreen 
    //if it logout then restart the app its go to loginpage
